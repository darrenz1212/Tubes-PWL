...
<h1 class="text-cream font-bold text-5xl text-center">Lupa password?</h1> <br>
    <div class="mb-4 text-sm text-center text-cream">
        <?php echo e(__('Masukkan email anda dan kami akan mengirimkan tautan untuk mengatur ulang password anda.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Femmy Friscilla\Downloads\Tubes-PWL-Darren-patch-2\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>